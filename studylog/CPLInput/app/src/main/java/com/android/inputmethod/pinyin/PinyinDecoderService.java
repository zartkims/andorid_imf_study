...
/**
 * Created by caipengli on 16年3月11日.
 */
public class PinyinDecoderService extends Service {
    ...
    static {
        try {
//            System.loadLibrary("libjni_pinyinime");
    ...
    private void initPinyinEngine() {
        ...
        // a file descriptor...
        AssetFileDescriptor afd = getResources().openRawResourceFd(R.raw.dict_pinyin);//cpl 这个后缀改为MP3突破1M
        if (InputEnvironment.getInstance().needDebug()) {
